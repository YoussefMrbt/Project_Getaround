...
EXPERIMENT_NAME = "Gradient_Boosting_Regression_Exp"
...
with mlflow.start_run(experiment_id=experiment.experiment_id):
    # Create a Gradient Boosting regression pipeline with the best hyperparameters
    ...
    # Store metrics
    predicted_qualities = gb_regressor.predict(X_test)
