...
EXPERIMENT_NAME="Ridge_Regression_Exp"
...
with mlflow.start_run(experiment_id = experiment.experiment_id):
    ...
    ridge_alpha = 2.0  # Adjust this based on your model tuning
    ridge_regressor = Pipeline(steps=[
    ...
    # Store metrics
    predicted_qualities = ridge_regressor.predict(X_test)
    RMSE = np.sqrt(mean_squared_error(Y_test, predicted_qualities))
    R2_train = ridge_regressor.score(X_train, Y_train)
    R2_test = ridge_regressor.score(X_test, Y_test)
