...
EXPERIMENT_NAME="Random_Forest_Regression_Exp"
...
with mlflow.start_run(experiment_id = experiment.experiment_id):
    # Create a Random Forest regression pipeline with best hyperparameters
    ...
    # Store metrics
    predicted_qualities = rf_regressor.predict(X_test)
